package com.yuetao.statelayout.statemanager;
...
import com.yuetao.statelayout.statemanager.manager.StateChanger;
import com.yuetao.statelayout.statemanager.manager.StateEventListener;
import com.yuetao.statelayout.statemanager.manager.StateManager;
...
public class StateLayout extends FrameLayout implements StateChanger, StateLoader {
    ...
    public boolean showState(String state, boolean isShowCore) {
        return stateManager.showState(state,isShowCore);
